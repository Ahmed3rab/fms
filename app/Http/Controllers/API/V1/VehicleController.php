...
{
    public function index(Request $request, TrackingGateway $tracking): AnonymousResourceCollection
    {
    ...
    public function show(Vehicle $vehicle, TrackingGateway $tracking): VehicleResource
    {
        $vehicle->load([
            'company',
            'device.state',
